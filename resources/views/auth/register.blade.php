            ...
            <div class="card mb-0">
              <div class="card-body">
                ...
                <form action="{{ route('register.action') }}"  method="POST" enctype="multipart/form-data">
                    ...
                    @method('POST')
                    <div class="mb-3">
                      <label for="exampleInputEmail1" class="form-label">Avatar (optional)</label>
                      <input type="file" class="form-control" id="exampleInputtext1" aria-describedby="emailHelp" name="avatar">
                    </div>
                    @error('avatar')
                ...
                @enderror
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="exampleInputtext1" aria-describedby="emailHelp" name="address">
                  </div>
                  @error('address')
                  <p class="text-warning text-sm">{{ $message }}</p>
                @enderror
