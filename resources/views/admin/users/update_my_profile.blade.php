<x-layout>
    <x-slot:title>Update My Profile</x-slot:title>
    <x-notiffication />
    <div class="card">
        <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Update My Profile</h5>
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('users.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="role" id="role" class="form-control" disabled>
                                ...
                                <option {{ $user->role == 'reader' ? 'selected' : '' }} value="reader">Reader</option>
                            </select>
